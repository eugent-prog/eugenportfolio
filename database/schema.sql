...
VALUES
  ...
  (
    ...
    'Full-stack app',
    2026,
    'A PHP and MySQL web app for tracking items, stock levels, and recent updates with searchable records.',
  ...
  (
    ...
    'Frontend app',
    2026,
    'A responsive dashboard concept with profile details, class summaries, status cards, and simple navigation patterns.',
    'HTML, CSS, JavaScript',
    NULL,
    NULL,
    20,
  ...
  (
    ...
    'Backend project',
    2025,
    'A backend service concept for creating tasks, assigning work, updating statuses, and validating request data.',
